...
describe('正则匹配的初步检查', function() {
	...
	it('U123 2016-06-02 20:00~22:00 A 应该通过', function() {
		expect(bookAndCancel('U123 2016-06-02 20:00~22:00 A', result)).to.be.true;
	});
	it('U123 2016-06-02 20:00~22:00 不应该通过', function() {
		expect(bookAndCancel('U123 2016-06-02 20:00~22:00', result)).to.be.false;
	});
	it('U123 2016-12-02 20:00~22:00 A B不应该通过', function() {
		expect(bookAndCancel('U123 2016-12-02 20:00~22:00 A B', result)).to.be.false;
	});
	it('U123 2016-12-02 20:00~22:00 B 应该通过', function() {
		expect(bookAndCancel('U123 2016-12-02 20:00~22:00 B', result)).to.be.true;
	});
	it(' 2016-12-02 20:00~22:00 B 不应该通过', function() {
		expect(bookAndCancel(' 2016-12-02 20:00~22:00 B', result)).to.be.false;
	});
...
describe("日期的合法化检查", function() {
	it('U123 2016-13-02 20:00~22:00 A 月份不对', function() {
		expect(bookAndCancel('U123 2016-13-02 20:00~22:00 A', result)).to.be.false;
	});
	it('U123 2016-06-2 20:00~22:00 A 日子不对', function() {
		expect(bookAndCancel('U123 2016-06-2 20:00~22:00 A', result)).to.be.false;
	});
	it('U123 2016-00-02 20:00~22:00 A 月份不对', function() {
		expect(bookAndCancel('U123 2016-00-02 20:00~22:00 A', result)).to.be.false;
	});
	it('U123 2016-2-31 20:00~22:00 A 日子超了不对', function() {
		expect(bookAndCancel('U123 2016-2-31 20:00~22:00 A', result)).to.be.false;
	});
	it('U123 2016-2-2 20:00~22:00 A 月份日子不对', function() {
		expect(bookAndCancel('U123 2016-2-2 20:00~22:00 A', result)).to.be.false;
	});
	/*下面对特殊月份进行检查：
		new Date('2015-02-28')
